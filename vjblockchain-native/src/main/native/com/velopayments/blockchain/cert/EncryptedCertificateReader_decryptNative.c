/**
 * \file EncryptedCertificateReader_decryptNative.c
 *
...
Java_com_velopayments_blockchain_cert_EncryptedCertificateReader_decryptNative(
    JNIEnv* env, jclass UNUSED(clazz), jbyteArray secretKey, jbyteArray input)
{
    ...
    {
        (*env)->ThrowNew(
            env, native_inst->NullPointerException.classid, "secretKey");
        return NULL;
    }
